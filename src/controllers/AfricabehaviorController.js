...
// // *** New Helper Function to handle z-score and phi calculation for any answers row ***
...
//         };
//         const TOTAL_WEIGHT = 6.383;

//         let overallScoreSum = 0;
//         for (const metric of results) {
//             const scoreDecimal = metric.Competency_Score_Percent / 100; 
//             const weight = WEIGHTS[metric.Competency];
...
//                         for (const name of competencyList) {
//                             const metrics = calculateCompetencyMetrics(name, teamPlayerQuestions, questionsMap);
...
//                         } else {
//                             teamAverageScores[name] = 0.00; // Default to 0 if no valid scores found
//                         }
//                     }
//                 }
//             }
...
//         // Final Return
//         return res.json({
//             Player_Behavior_Overall_Score: finalOverallScore * 100, 
//             Competency_Metrics: results,
//             // NEW FIELD: Contains average for ALL 10 competencies
